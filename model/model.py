...
with col:
    ...
    with col1:
        st.image('/home/wecode-016/RenduData/bigdata/model/cancer.png')
    with col2:
    ...
    with tab1:
        ...
        data = pd.read_csv('/home/wecode-016/RenduData/bigdata/model/file_set.csv')
        data_set = data.drop('Unnamed: 0', axis=1)
        data_set
        data_set['diagnosis']=data_set['diagnosis'].map({'B':0,'M':1})
        model = joblib.load('/home/wecode-016/RenduData/bigdata/model/breast_cancer_model.pkl')
